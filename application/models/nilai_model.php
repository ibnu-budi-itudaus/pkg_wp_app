...
class nilai_Model extends CI_Model
{
    ...
    public function getdata($tahun)
    {
        $this->db->select('*');
        $this->db->from('nilai');
        $this->db->join('guru', 'guru.id_guru=nilai.id_guru', 'left');
        $this->db->join('kriteria', 'kriteria.id_kriteria=nilai.id_kriteria', 'left');
        // $this->db->order_by('alternatif.id_alternatif');
     ...
     public function get_AllKriteriaAndSub()
    {
     ...
     public function get_Allcandidat($tahun)
    {
        $this->db->select('*');
      $this->db->from('nilai');
