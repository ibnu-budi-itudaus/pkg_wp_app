        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="<?= base_url('alternatiff') ?>">Alternatif</a>
                    </li>
                    <li class="separator">
                        <i class="flaticon-right-arrow"></i>
                    </li>
            ...
            <?php } else if ($this->session->flashdata('kosong')) { ?>
                <div class="alert alert-danger alert-dismissable">
                    <h4><?= $this->session->flashdata('kosong'); ?> <a href="<?= base_url('alternatiff') ?>">disini</a></h4>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <h2>Nilai Alternatif - Penilaian Kinerja Guru (PKG)</h2>
                    ...
                    <?php } else { ?>
                        <h2>Hasil Kinerja <?= $guru['0']['nama_guru'] ?> adalah <?= $jml_nilai['skala'] ?></h2>
                    <?php } ?>
                    ...
                    <div class="collapse" id="collapseExample">
                        <div class="table-responsive">
                            <h2>Hasil Penilaian Kinerja Guru (PKG) - <?php echo $guru['0']['nama_guru'] ?></h2>
