...
<body class="login">
			...
			<div class="container container-login animated fadeIn">
                        ...
                        <div class="icon d-flex align-items-center justify-content-center"  style="margin-top: -20px;">
                            <img src="<?= base_url(); ?>assets/img/logopkg.png" alt="" width="300px" height="300px">
	...
	<div class="wrapper wrapper-login" style="margin-top: -185px;">
		<div class="container container-login animated fadeIn">
			<h3 class="text-center">Login To PKG APP</h3>
