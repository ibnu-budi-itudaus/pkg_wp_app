                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                ...
                                                <?php if($admin['akses'] == "Penilai") { ?>
                                                <a href="<?= base_url('nilai/hitung/') . $g['id_guru'] ?>" class="btn btn-link btn-success" onclick="return confirm('Nilai kinerja guru ini?')">
                                                    <i class="fas fa-calculator">Nilai</i>
                                                </a>
