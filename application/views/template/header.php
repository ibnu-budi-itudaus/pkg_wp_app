...
<head>
    ...
    <link rel="icon" href="<?= base_url(); ?>assets/img/logopkgg.ico" type="image/x-icon" />
                ...
                <div class="sidebar-content">
                    ...
                    <ul class="nav">
                        ...
                        <?php if ($admin['akses'] == "Administrator") { ?>
                            ...
                            <li class="nav-item <?php if ($position == 'Sub Kriteria') { ?> active <?php } ?>">
                            ...
                            <li class="nav-item <?php if ($position == 'Alternatif') { ?> active <?php } ?>">
                                <a href="<?= base_url('alternatiff') ?>">
                                    <i class="fas fa-users"></i>
                                    <p>Alternatif</p>
                                </a>
                            </li>

                            <li class="nav-item <?php if ($position == 'Analisa WP') { ?> active <?php } ?>">
                                <a href="<?= base_url('analisa_wp') ?>">
                        ...
                        <?php } ?>
                         <?php if ($admin['akses'] == "Administrator" || $admin['akses'] == "Penilai") { ?>
                    ...
                    <?php } ?>
                        <li class="nav-item <?php if ($position == 'Peringkat Guru') { ?> active <?php } ?>">
                            <a href="<?= base_url('peringkat') ?>">
                                <i class="fas fa-trophy"></i> 
                                <p>Peringkat Guru</p>
                            </a>
                        </li>
                        <li class="nav-item <?php if ($position == 'Laporan') { ?> active <?php } ?>">
